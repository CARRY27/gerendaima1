...
import user_project from "@/page/content/user/user_project"
import user_volunteer from "@/page/content/user/user_volunteer";
import user_assist from "@/page/content/user/user_assist";
...
export default [
  ...
  { path: '/user_project', name: 'user_project', component: user_project },
  ...
  {path: "/user/user_project", name:'user_project',component: user_project},
  {path: "/user_volunteer", name:'user_volunteer',component: user_volunteer}, 
  {path: "/user_assist", name:'user_assist',component: user_assist}
]
