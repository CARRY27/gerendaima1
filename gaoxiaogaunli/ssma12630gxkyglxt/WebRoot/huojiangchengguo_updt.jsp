...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑获奖成果:</div>
            <div class="panel-body">
                <form action="huojiangchengguoupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_huojiangjibie45"
                                    data-value="${Info.html(mmm.huojiangjibie)}"
                                    id="huojiangjibie"
                                    name="huojiangjibie"
                                    style="width: 250px"
                                >
                                ...
                                <script>
                                    $(".class_huojiangjibie45").val($(".class_huojiangjibie45").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="huojiangdengji"
                                    name="huojiangdengji"
                                    value="${Info.html(mmm.huojiangdengji)}"
                                />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input id="huojiangchengyuan" name="huojiangchengyuan" value="${Info.html(mmm.huojiangchengyuan)}" type="text" />
                                <script>
                                    $(function () {
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="pizhundanwei"
                                    name="pizhundanwei"
                                    value="${Info.html(mmm.pizhundanwei)}"
                                />
                            </div>
                        </div>
                    </div>
