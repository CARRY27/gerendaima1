...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑创作成果:</div>
            <div class="panel-body">
                <form action="chuangzuochengguoupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="huojiangzhe"
                                    name="huojiangzhe"
                                    value="${Info.html(mmm.huojiangzhe)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    value="${Info.html(mmm.huojiangmingcheng)}"
                                />
                            </div>
                        </div>
                    </div>
