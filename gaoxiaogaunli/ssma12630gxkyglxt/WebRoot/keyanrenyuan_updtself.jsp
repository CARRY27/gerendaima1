...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑科研人员:</div>
            <div class="panel-body">
                <form action="keyanrenyuanupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="checkno.do?checktype=update&id=${mmm.id}&table=keyanrenyuan&col=yonghuming"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="shenfenzheng"
                                    name="shenfenzheng"
                                    value="${Info.html(mmm.shenfenzheng)}"
                                />
                            </div>
                        </div>
                    </div>
