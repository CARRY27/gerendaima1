...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑论文成果:</div>
            <div class="panel-body">
                <form action="lunwenchengguoupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="lunwenbianhao"
                                    name="lunwenbianhao"
                                    value="${Info.html(mmm.lunwenbianhao)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="lunwentimu"
                                    name="lunwentimu"
                                    value="${Info.html(mmm.lunwentimu)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="diyizuozhe"
                                    name="diyizuozhe"
                                    value="${Info.html(mmm.diyizuozhe)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="tongxunzuozhe"
                                    name="tongxunzuozhe"
                                    value="${Info.html(mmm.tongxunzuozhe)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    value="${Info.html(mmm.fabiaochubanshijian)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    value="${Info.html(mmm.fabiaokanwulunwenji)}"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_xuekefenlei23"
                                    data-value="${Info.html(mmm.xuekefenlei)}"
                                    id="xuekefenlei"
                                    name="xuekefenlei"
                                    style="width: 250px"
                                >
                                ...
                                <script>
                                    $(".class_xuekefenlei23").val($(".class_xuekefenlei23").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入卷号" style="width: 150px" id="juanhao" name="juanhao" value="${Info.html(mmm.juanhao)}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入期号" style="width: 150px" id="qihao" name="qihao" value="${Info.html(mmm.qihao)}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入字数" style="width: 150px" id="zishu" name="zishu" value="${Info.html(mmm.zishu)}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="yemafanwei"
                                    name="yemafanwei"
                                    value="${Info.html(mmm.yemafanwei)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group" style="width: 250px">
                                    <input type="text" class="form-control" id="fujian" name="fujian" value="${Info.html(mmm.fujian)}" />
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea style="width: 80%; height: 120px" class="form-control" placeholder="输入简介" id="jianjie" name="jianjie">
${Info.html(mmm.jianjie)}</textarea
                                >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    value="${Info.html(mmm.tianjiarenxingming)}"
                                />
                            </div>
                        </div>
                    </div>
