            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select
                            class="form-control class_chubansheleibie28"
                        ...
                        <script>
                            $(".class_chubansheleibie28").val($(".class_chubansheleibie28").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        著作类别
                        ...
                        <select
                            class="form-control class_zhuzuoleibie29"
                        ...
                        <script>
                            $(".class_zhuzuoleibie29").val($(".class_zhuzuoleibie29").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        分值

                        <select class="form-control class_fenzhi30" data-value="${param.fenzhi}" data-rule-required="true" data-msg-required="请填写分值" id="fenzhi" name="fenzhi">
                            <option value="">请选择</option>
                        ...
                        <script>
                            $(".class_fenzhi30").val($(".class_fenzhi30").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        本人排序
                        ...
                        <select
                            class="form-control class_benrenpaixu31"
                        ...
                        <script>
                            $(".class_benrenpaixu31").val($(".class_benrenpaixu31").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        添加人
