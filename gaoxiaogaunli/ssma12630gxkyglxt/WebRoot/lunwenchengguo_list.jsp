            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_xuekefenlei20" data-value="${param.xuekefenlei}" id="xuekefenlei" name="xuekefenlei">
                            <option value="">请选择</option>
                            <option value="科技类">科技类</option>
                            <option value="社科类">社科类</option>
                        </select>
                        <script>
                            $(".class_xuekefenlei20").val($(".class_xuekefenlei20").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        卷号
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>
                                    ${map.issh}
                                    <a href="sh.do?id=${map.id}&yuan=${map.issh}&tablename=lunwenchengguo">
