...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑物资:</div>
            <div class="panel-body">
                <form action="wuziupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="wuzimingcheng"
                                    name="wuzimingcheng"
                                    value="${Info.html(mmm.wuzimingcheng)}"
                                />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_fenlei63" data-value="${Info.html(mmm.fenlei)}" id="fenlei" name="fenlei" style="width: 250px">
                                ...
                                <script>
                                    $(".class_fenlei63").val($(".class_fenlei63").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="kucunshuliang"
                                    name="kucunshuliang"
                                    value="${Info.html(mmm.kucunshuliang)}"
                                />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea style="width: 80%; height: 120px" class="form-control" placeholder="输入物资用处" id="wuziyongchu" name="wuziyongchu">
${Info.html(mmm.wuziyongchu)}</textarea
                                >
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea style="width: 80%; height: 120px" class="form-control" placeholder="输入描述" id="miaoshu" name="miaoshu">
${Info.html(mmm.miaoshu)}</textarea
                                >
                            </div>
                        </div>
                    </div>
