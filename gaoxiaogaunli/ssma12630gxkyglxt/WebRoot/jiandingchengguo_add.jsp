...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加鉴定成果:</div>
            <div class="panel-body">
                <form action="jiandingchengguoinsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入鉴定单位" style="width: 150px" id="jiandingdanwei" name="jiandingdanwei" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入鉴定日期" style="width: 150px" id="jiandingriqi" name="jiandingriqi" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
