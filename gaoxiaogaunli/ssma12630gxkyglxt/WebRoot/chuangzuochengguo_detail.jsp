...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        <div class="panel-heading">创作成果详情</div>
        <div class="panel-body">
            <div class="admin-detail clearfix">
                <div class="detail detail-text">
                    <div class="detail-title">年度：</div>
                    <div class="detail-content">${map.niandu}</div>
                </div>
                <div class="detail detail-text">
                    <div class="detail-title">学科：</div>
                    <div class="detail-content">${map.xueke}</div>
                </div>
                <div class="detail detail-text">
                    <div class="detail-title">获奖者：</div>
                    <div class="detail-content">${map.huojiangzhe}</div>
                </div>
                ...
                <div class="detail detail-longtext">
                    <div class="detail-title">获奖名称：</div>
                    <div class="detail-content">${map.huojiangmingcheng}</div>
                </div>
