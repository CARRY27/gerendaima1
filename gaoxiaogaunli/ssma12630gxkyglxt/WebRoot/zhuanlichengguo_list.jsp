            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_chengguoleibie46" data-value="${param.chengguoleibie}" id="chengguoleibie" name="chengguoleibie">
                        ...
                        <script>
                            $(".class_chengguoleibie46").val($(".class_chengguoleibie46").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        依托项目
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_zhuanlijishufenzhi47" data-value="${param.zhuanlijishufenzhi}" id="zhuanlijishufenzhi" name="zhuanlijishufenzhi">
                            <option value="">请选择</option>
                        ...
                        <script>
                            $(".class_zhuanlijishufenzhi47").val($(".class_zhuanlijishufenzhi47").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        本人排序

                        <select class="form-control class_benrenpaixu48" data-value="${param.benrenpaixu}" id="benrenpaixu" name="benrenpaixu">
                            <option value="">请选择</option>
                        ...
                        <script>
                            $(".class_benrenpaixu48").val($(".class_benrenpaixu48").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        是否第一单位

                        <select class="form-control class_shifoudiyidanwei49" data-value="${param.shifoudiyidanwei}" id="shifoudiyidanwei" name="shifoudiyidanwei">
                            <option value="">请选择</option>
                            <option value="是">是</option>
                            <option value="否">否</option>
                        </select>
                        <script>
                            $(".class_shifoudiyidanwei49").val($(".class_shifoudiyidanwei49").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        添加人
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>
                                    ${map.issh}
                                    <a href="sh.do?id=${map.id}&yuan=${map.issh}&tablename=zhuanlichengguo">
