...
-->
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;">欢迎登录高校科研管理系统，${sessionScope.username}，权限${sessionScope.cx}</a>
        </li>
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            ...
            <c:choose> <c:when test="${'科研人员' == sessionScope.cx }">
                <%@ include file="left_keyanrenyuan.jsp" %>
            </c:when></c:choose>
            <!--leftmenu-->
        </ul>
    </div>
