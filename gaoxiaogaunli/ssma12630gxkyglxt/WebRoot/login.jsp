...
<html class="x-admin-sm">
    ...
    <body class="login-bg">
        <div class="login layui-anim layui-anim-up">
            <div class="message">高校科研管理系统-管理登录</div>
            ...
            <form method="post" class="layui-form" action="authAdminLogin.do?a=a">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <img alt="刷新验证码" onClick="this.src='captcha.do?time='+new Date().getTime();" src="captcha.do" style="cursor: pointer; padding-top: 10px" />
                    </div>
                </div>
                <hr class="hr15" />
