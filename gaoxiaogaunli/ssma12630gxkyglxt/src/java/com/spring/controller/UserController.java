...
public class UserController extends BaseController {
    ...
    protected String authLoginUser(boolean isAdmin, String username, String pwd, String cx) {
        ...
        if (cx.equals("科研人员")) {
            Keyanrenyuan user = keyanrenyuanService.login(username, pwd);
            if (user == null) {
                return showError("用户名或密码错误");
            }
            session.setAttribute("id", user.getId());
            ...
            session.setAttribute("yuanxi", user.getYuanxi());
    ...
    public String editPassword() {
        ...
        if (cx.equals("科研人员")) {
            Keyanrenyuan user = keyanrenyuanService.login(username, oldPassword);
            if (user == null) {
                return showError("原密码不正确");
            }
            keyanrenyuanService.updatePassword(user.getId(), newPwd);
        }
